...
/** @export */
window.asyncCSS;
window.asyncCSS.load = function() {};
window.asyncCSS.on = function() {};
window.asyncCSS.once = function() {};
window.asyncCSS.then = function() {};
window.perfMark = function() {};

window.asyncJS;
window.asyncJS.load = function() {};
window.asyncJS.on = function() {};
window.asyncJS.once = function() {};
window.asyncJS.then = function() {};
